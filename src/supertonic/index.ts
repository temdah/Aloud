...
export { chunkText, buildChunks, createNarrationPlan, EMPTY_NARRATION_PLAN, buildSentenceAnchors, MAX_SENTENCE_ANCHOR_CHARS, sentenceAnchorId, sentenceCacheBaseName, sentenceSettingsHash, findChunkIndexForOffset, ensureChunkAudio, ensureLeadAudio, ensureSentenceAudio, isChunkCached, isLeadCached, isSentenceCached, leadAudioFile, chunkAudioUri, sentenceAudioUri, readSentenceTiming, writeSentenceTiming, deleteChunkCache, deleteSentenceCache, deleteLeadCache, deleteAudiobookCache, isAudiobookCached, audiobookAudioUri, readAudiobookIndex, settingsHash, recordSentenceCachedProfile, clearDocumentCache, clearFragmentedCache, documentCacheStats, listCachedProfiles, clearProfileCache, loadChunks, loadNarrationPlan, readManifest, prerenderDocument, planProsody, ensureDurationTable, buildTimeline, loadDurationTable, loadDurationTableFromCache, cumulativeOffsetsSec, totalDurationSec, locateTime, clearNarrationPerfCounters, getNarrationPerfCounters, getSynthRtf } from './narration';
export type { NarrationMetricsReporter, NarrationPlan, NarrationSettings, NarrationSynthesisMetrics, PrerenderProgress, PrerenderResult, ProsodyBoundary, ProsodyPlan, CachedProfile, ProfileMeta, DurationTable, TimeLocation } from './narration';
