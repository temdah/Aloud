...
// Spacing scale (dp), keyed 1..10 as in the design.
...
// The design's ELEV box-shadows translated to RN shadow + Android elevation.
...
export function elevation(level: ElevationLevel): ViewStyle {
  if (level === 0) return {};
  return {
    shadowColor: '#281e0f', // warm paper shadow (rgb 40,30,15)
